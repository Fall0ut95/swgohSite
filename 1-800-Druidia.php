...
<div class="col-lg-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
	<div class="well druidia-well">
		<h2><center>GiD 1-800-Druidia</center></h2>
		<img src="images/1800DR.png" height="300" class="druidia-center"><br />
		<h4><center>Leaders:</center></h4>
		<p><center>RemainingUchiha and U2EzKID</center></p>
	</div>
	<div class="row">
	<div class="col-lg-6 col-lg-6 col-md-6 col-sm-6 col-xs-6">
		<iframe src="https://calendar.google.com/calendar/b/1/embed?height=600&amp;wkst=1&amp;bgcolor=%23FFFFFF&amp;src=176dtje63m5o7ca3oqtmduoi2o%40group.calendar.google.com&amp;color=%232952A3&amp;ctz=America%2FNew_York" style="border-width:0"frameborder="0" scrolling="no" class="calendar"></iframe>
	</div>	
	</div>
</div>
...
<div class="table-body col-xl-6 col-lg-6 col-md-6 col-sm-8 col-xs-12">
	<table class="druidia-guild-info-table" id="druidia-table">
		<tr class="druidia-guild-info-row">
	...
	<script type="text/javascript">
		function sortTable(n){
			...
			table = document.getElementById("druidia-table");
			switching = true;
