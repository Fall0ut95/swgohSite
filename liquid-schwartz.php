...
<html lang="en">
<head>
  <title>GiD Liquid Schwartz</title>
  <meta charset="utf-8">
...
<div class="col-lg-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
	<div class="well liquidSchwartz-well">
		<h2><center>GiD Liquid Schwartz</center></h2>
		<img src="images/LS.png" height="300" class="liquid-schwartz-center"><br />
		<h4><center>Leaders:</center></h4>
		<p><center>GiD Keene and Silverteg2000</center></p>
	</div>
	<div class="row">
	<div class="col-lg-6 col-lg-6 col-md-6 col-sm-6 col-xs-6">
		<iframe src="https://calendar.google.com/calendar/embed?src=8pc4mke7rpem6v9atg4kj0f22o%40group.calendar.google.com&ctz=America%2FChicago" style="border: 0" frameborder="0" scrolling="no" class="calendar"></iframe>
	</div>	
	</div>
</div>
...
<div class="table-body col-xl-6 col-lg-6 col-md-6 col-sm-8 col-xs-12">
	<table class="liquid-schwartz-guild-info-table" id="liquid-schwartz-table">
		<tr class="liquidSchwartz-guild-info-row">
	...
	<script type="text/javascript">
		function sortTable(n){
			...
			table = document.getElementById("liquid-schwartz-table");
			switching = true;
...
<style>
	.liquid-schwartz-guild-info-table{
		margin-bottom: 30px;
